...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.driverAgreement.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.driver-agreements.update", [$driverAgreement->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('driver') ? 'is-invalid' : '' }}" name="driver_id" id="driver_id" required>
                    @foreach($drivers as $id => $entry)
                        <option value="{{ $id }}" {{ (old('driver_id') ? old('driver_id') : $driverAgreement->driver->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('car_item') ? 'is-invalid' : '' }}" name="car_item_id" id="car_item_id" required>
                    @foreach($car_items as $id => $entry)
                        <option value="{{ $id }}" {{ (old('car_item_id') ? old('car_item_id') : $driverAgreement->car_item->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('start_date') ? 'is-invalid' : '' }}" type="text" name="start_date" id="start_date" value="{{ old('start_date', $driverAgreement->start_date) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('end_date') ? 'is-invalid' : '' }}" type="text" name="end_date" id="end_date" value="{{ old('end_date', $driverAgreement->end_date) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('weekly_income_high') ? 'is-invalid' : '' }}" type="number" name="weekly_income_high" id="weekly_income_high" value="{{ old('weekly_income_high', $driverAgreement->weekly_income_high) }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('weekly_income_low') ? 'is-invalid' : '' }}" type="number" name="weekly_income_low" id="weekly_income_low" value="{{ old('weekly_income_low', $driverAgreement->weekly_income_low) }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('additional_km_value_high') ? 'is-invalid' : '' }}" type="number" name="additional_km_value_high" id="additional_km_value_high" value="{{ old('additional_km_value_high', $driverAgreement->additional_km_value_high) }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('additional_km_value_low') ? 'is-invalid' : '' }}" type="number" name="additional_km_value_low" id="additional_km_value_low" value="{{ old('additional_km_value_low', $driverAgreement->additional_km_value_low) }}" step="0.01" required>
