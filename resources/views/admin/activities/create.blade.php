    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.activities.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('operator_code') ? 'is-invalid' : '' }}" type="text" name="operator_code" id="operator_code" value="{{ old('operator_code', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('net') ? 'is-invalid' : '' }}" type="number" name="net" id="net" value="{{ old('net', '') }}" step="0.01">
                @if($errors->has('net'))
