    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.seasons.update", [$season->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Season::SEASON_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('season') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="season_{{ $key }}" name="season" value="{{ $key }}" {{ old('season', $season->season) === (string) $key ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('start_date') ? 'is-invalid' : '' }}" type="text" name="start_date" id="start_date" value="{{ old('start_date', $season->start_date) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('end_date') ? 'is-invalid' : '' }}" type="text" name="end_date" id="end_date" value="{{ old('end_date', $season->end_date) }}" required>
