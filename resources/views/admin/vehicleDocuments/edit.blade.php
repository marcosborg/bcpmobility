...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.vehicleDocument.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.vehicle-documents.update", [$vehicleDocument->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('car_item') ? 'is-invalid' : '' }}" name="car_item_id" id="car_item_id" required>
                    @foreach($car_items as $id => $entry)
                        <option value="{{ $id }}" {{ (old('car_item_id') ? old('car_item_id') : $vehicleDocument->car_item->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('carta_verde') ? 'is-invalid' : '' }}" type="text" name="carta_verde" id="carta_verde" value="{{ old('carta_verde', $vehicleDocument->carta_verde) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('condicoes_particulares') ? 'is-invalid' : '' }}" type="text" name="condicoes_particulares" id="condicoes_particulares" value="{{ old('condicoes_particulares', $vehicleDocument->condicoes_particulares) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('dua') ? 'is-invalid' : '' }}" type="text" name="dua" id="dua" value="{{ old('dua', $vehicleDocument->dua) }}">
                @if($errors->has('dua'))
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('dav') ? 'is-invalid' : '' }}" type="text" name="dav" id="dav" value="{{ old('dav', $vehicleDocument->dav) }}">
                @if($errors->has('dav'))
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('tvde_license') ? 'is-invalid' : '' }}" type="text" name="tvde_license" id="tvde_license" value="{{ old('tvde_license', $vehicleDocument->tvde_license) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('inspecao_tecnica_periodica') ? 'is-invalid' : '' }}" type="text" name="inspecao_tecnica_periodica" id="inspecao_tecnica_periodica" value="{{ old('inspecao_tecnica_periodica', $vehicleDocument->inspecao_tecnica_periodica) }}">
