    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.drivers.update", [$driver->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('uber_uuid') ? 'is-invalid' : '' }}" type="text" name="uber_uuid" id="uber_uuid" value="{{ old('uber_uuid', $driver->uber_uuid) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('bolt_name') ? 'is-invalid' : '' }}" type="text" name="bolt_name" id="bolt_name" value="{{ old('bolt_name', $driver->bolt_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('driver_license') ? 'is-invalid' : '' }}" type="text" name="driver_license" id="driver_license" value="{{ old('driver_license', $driver->driver_license) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('citizen_card') ? 'is-invalid' : '' }}" type="text" name="citizen_card" id="citizen_card" value="{{ old('citizen_card', $driver->citizen_card) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('driver_vat') ? 'is-invalid' : '' }}" type="text" name="driver_vat" id="driver_vat" value="{{ old('driver_vat', $driver->driver_vat) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('payment_vat') ? 'is-invalid' : '' }}" type="text" name="payment_vat" id="payment_vat" value="{{ old('payment_vat', $driver->payment_vat) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('iban') ? 'is-invalid' : '' }}" type="text" name="iban" id="iban" value="{{ old('iban', $driver->iban) }}">
                @if($errors->has('iban'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('zip') ? 'is-invalid' : '' }}" type="text" name="zip" id="zip" value="{{ old('zip', $driver->zip) }}">
                @if($errors->has('zip'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('city') ? 'is-invalid' : '' }}" type="text" name="city" id="city" value="{{ old('city', $driver->city) }}">
                @if($errors->has('city'))
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('start_date') ? 'is-invalid' : '' }}" type="text" name="start_date" id="start_date" value="{{ old('start_date', $driver->start_date) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('end_date') ? 'is-invalid' : '' }}" type="text" name="end_date" id="end_date" value="{{ old('end_date', $driver->end_date) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('reason') ? 'is-invalid' : '' }}" type="text" name="reason" id="reason" value="{{ old('reason', $driver->reason) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('notes') ? 'is-invalid' : '' }}" name="notes" id="notes">{{ old('notes', $driver->notes) }}</textarea>
                @if($errors->has('notes'))
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('fuel_cards') ? 'is-invalid' : '' }}" name="fuel_cards[]" id="fuel_cards" multiple>
                    @foreach($fuel_cards as $id => $fuel_card)
                        <option value="{{ $id }}" {{ (in_array($id, old('fuel_cards', [])) || $driver->fuel_cards->contains($id)) ? 'selected' : '' }}>{{ $fuel_card }}</option>
                    @endforeach
                </select>
