...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.carItem.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.car-items.update", [$carItem->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('car_brand') ? 'is-invalid' : '' }}" name="car_brand_id" id="car_brand_id" required>
                    @foreach($car_brands as $id => $entry)
                        <option value="{{ $id }}" {{ (old('car_brand_id') ? old('car_brand_id') : $carItem->car_brand->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('car_model') ? 'is-invalid' : '' }}" name="car_model_id" id="car_model_id" required>
                    @foreach($car_models as $id => $entry)
                        <option value="{{ $id }}" {{ (old('car_model_id') ? old('car_model_id') : $carItem->car_model->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('year') ? 'is-invalid' : '' }}" type="number" name="year" id="year" value="{{ old('year', $carItem->year) }}" step="1">
                @if($errors->has('year'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('license_plate') ? 'is-invalid' : '' }}" type="text" name="license_plate" id="license_plate" value="{{ old('license_plate', $carItem->license_plate) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('motorization') ? 'is-invalid' : '' }}" type="text" name="motorization" id="motorization" value="{{ old('motorization', $carItem->motorization) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('chassis_number') ? 'is-invalid' : '' }}" type="text" name="chassis_number" id="chassis_number" value="{{ old('chassis_number', $carItem->chassis_number) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('internal_name') ? 'is-invalid' : '' }}" type="text" name="internal_name" id="internal_name" value="{{ old('internal_name', $carItem->internal_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cost_per_km') ? 'is-invalid' : '' }}" type="number" name="cost_per_km" id="cost_per_km" value="{{ old('cost_per_km', $carItem->cost_per_km) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('monthly_income') ? 'is-invalid' : '' }}" type="number" name="monthly_income" id="monthly_income" value="{{ old('monthly_income', $carItem->monthly_income) }}" step="0.01">
