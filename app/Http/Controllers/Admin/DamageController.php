...
class DamageController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            $table->addColumn('positioning_map_license_plate', function ($row) {
                return $row->positioning_map ? $row->positioning_map->license_plate : '';
            });
            ...
            $table->rawColumns(['actions', 'placeholder', 'positioning_map', 'photos']);
