...
class VehicleExpensesController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            $query = VehicleExpense::with(['car_item'])->select(sprintf('%s.*', (new VehicleExpense)->table));
            ...
            $table->rawColumns(['actions', 'placeholder', 'car_item', 'files']);
        ...
        return view('admin.vehicleExpenses.index', compact('car_items'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.vehicleExpenses.create', compact('car_items'));
    }
    ...
    public function edit(VehicleExpense $vehicleExpense)
    {
        ...
        $vehicleExpense->load('car_item');

        return view('admin.vehicleExpenses.edit', compact('car_items', 'vehicleExpense'));
    }
